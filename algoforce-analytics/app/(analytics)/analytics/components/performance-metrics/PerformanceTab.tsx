// algoforce-analytics\app\(analytics)\analytics\_(components)\PerformanceMetrics\PerformanceTab.tsx
"use client";

import NoData from "../NoDataCard";
import type { MetricsPayload } from "../../types";
import CumulativePnlCard from "./CumulativePnlCard";
import RollingRiskCard from "./RollingSharpeCard";
import LosingStreakChart from "./LosingStreakChart";
import ProbDDExceedChart from "./ProbDDExceedXChart";
import ProbLossKChart from "./ProbLossKChart";
import PnlBreakdownCard from "./PnlBreakdownCard";
import HitRatioChart from "./HitRatioChart";
